---
name: report
description: "Use when the user wants a durable PRD-based single-source report under docs/report. Routes to initialization, brainstorming, update, audit, or debate workflows. The report family supports research-prd and engineering-prd sources, rendered to both report.pdf and report.md."
---
...
- `report-update`: write confirmed conclusions into the PRD, re-render `report.pdf` plus `report.md`, and run consistency checks.
- `report-audit`: review PRD structure, evidence boundaries, acceptance gates, readability, dual-artifact freshness, and release readiness.
- `report-debate`: run structured pro/con reasoning on a disputed PRD claim, section, or design choice.
...
- If a change is high-disagreement or under-argued, prefer `report-debate`.
...
- whether a disputed claim should enter `report-debate`.
...
- “某个 claim / 设计路线需要正反裁决” -> `report-debate`
